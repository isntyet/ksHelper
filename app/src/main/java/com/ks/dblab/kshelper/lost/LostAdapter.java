...
public class LostAdapter extends RecyclerView.Adapter<LostAdapter.ViewHolder> {
    ...
    public LostAdapter(Context context, List<LostItem> items, int item_layout) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final LostItem item = items.get(position);
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(context, LostDetailActivity.class);

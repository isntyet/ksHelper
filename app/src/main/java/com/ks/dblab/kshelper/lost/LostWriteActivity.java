...
import com.ks.dblab.kshelper.request.LostImageRequest;
 ...
 */
public class LostWriteActivity extends BaseActivity {
    ...
    protected void createActivity(Bundle savedInstanceState) {
        View view = this.setContainerView(R.layout.activity_lost_write);
        getSupportActionBar().setTitle("분실물 글쓰기");
    ...
    private void imageRequest(){
        LostImageRequest request = new LostImageRequest(this);
    ...
    protected void viewClick(View view) {
        if (view.getId() == R.id.btn_back) {
            ...
            if(check == true){
                imageRequest();
                Toast.makeText(this, "주인을 찾길 기원합니다ㅎ", Toast.LENGTH_LONG).show();
                this.finish();
            }
        }
    }
